...
void display_centered_text(SSD1306_t *dev, int row, char *text, int text_len, bool invert) {
    int start_col = (128 - (text_len * 8)) / 2;
    ssd1306_display_text(dev, row, text, text_len, invert);
}
